...
import {Button, ButtonGroup, Grid, Rating, Stack, Tooltip, Typography} from "@mui/material";
...
import {CARD_VIEW_REPORT, GET_ALL_COURSE, SHOW_CARD_BY_ID} from "./CardView/Struct"
...
function CardTitleAuthorThemeAndCopyrightBlock({
                                                   id,
                                                   title,
                                                   copyright,
                                                   subTheme,
                                                   ...
                                                   isCardUseCopyright,
                                                   isMobile
                                               }: CardTitleAuthorThemeAndCopyrightBlockProps) {
    return <Row className="mt-4">
        <Col className="col-12">
            <Row className="pl-2">
                <Typography id={"card-title"} className="pl-md-2"
                            variant={isMobile ? "h6" : "h4"}>{title ? title : ""}</Typography>
                <Typography id={"card-id"} className="pl-md-2"
                            variant={isMobile ? "subtitle2" : "subtitle1"}>{id ? id : ""}</Typography>
                        ...
                        {props.openFromCourse ?
                            <Grid container>
                                ...
                                <Grid item md={8} xs={12} style={{paddingLeft: isMobile ? 0 : 12}}>
                                    {!card_data ?
                                        <Spinner id={"course-only-loading"} animation="border" variant="success"
                                                 className=" offset-6 mt-5"/> :
                            ...
                            <Stack direction={"row"} justifyContent="space-between">
                                <ButtonGroup sx={{pt: 2}} size="large" color="primary" aria-label="group"
                                ...
                                {UserStorage.userAccessLevel == "ADMIN" &&
                                    <div>
                                        <IconButton size="large"
                                                    onClick={() => {
                                                        history.push("/editor/card2/card/" + id)
                                                    }}>
                            ...
                            <Row>
                                ...
                                {!isMobile &&
                                    <Col className="col-12 col-lg-6 mt-4">
                                        ...
                                        <Typography className="blockquote">На сколько эта карточка была
                                            полезна?</Typography>
                                        <Rating
                                            className="pl-md-3"
                                ...
                                {isMobile &&
                                    <Col className="col-12 col-lg-6 mt-4">
                                        {/*<Typography>*/}
                                        <RichTextPreview id={"rich-text-preview"} text={card_data?.cardById?.text}
                                                         onChange={() => void (0)}/>
                                        {/*</Typography>*/}
                                        <Typography className="blockquote" id={"card-rating"}>Насколько эта карточка
                                            была полезна?</Typography>
                                        <Rating
                                            className="pl-md-3"
                                            name="simple-controlled"
                                            value={rating}
                                    ...
                                    >
                                        ...
                                        <DialogContent>
                                            <DialogContentText id="alert-dialog-description">
                                                Перед изучением данного ресурса, мы советуем Вам проверить свой уровень
                                                подготовки,
