...
const QuestionNanoViewByID = observer(({question_id, ...props}: IQuestionNanoViewByIDProps) => {
    const [QuestionObject] = useState(new QuestionNanoViewByIdStore(question_id))
