            ...
            >
                ...
                <DialogContent>
                    <DialogContentText id="alert-dialog-description">
                        Для того, чтобы собирать и анализировать статистику, нам необходимо знать,
                        кто проходил вопрос или серию вопросов, поэтому, мы будем благодарны, если Вы войдете
                        в аккаунт или введете имя по которому Вас можно будет идентифицировать. Спасибо за вашу помощь
                        @Команда Study Ways
                    </DialogContentText>
                </DialogContent>
                <DialogActions>
