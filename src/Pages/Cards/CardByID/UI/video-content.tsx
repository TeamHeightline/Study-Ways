...
const VideoContent = observer(({card_store}: IYoutubeContentProps) => {
    ...
    const [videoHosting, setVideoHosting] = useState<'VK' | 'Youtube' | 'Rutube'>(() => getDefaultVideoMode(isHaveVKVideo, isHaveYoutubeVideo))
                ...
                <div style={{width: '100%', display: 'flex', flex: 1}}>
                    {videoHosting === 'VK' ?
                        ...
                        videoHosting === 'Youtube' ?
                            <YoutubeContent card_store={card_store}/> : null
                    }
                </div>
                <ToggleButtonGroup
                    sx={{
                    ...
                    <ToggleButton value="Rutube" disabled>RU</ToggleButton>
                </ToggleButtonGroup>
            </Box>
