...
const UICreateErrorReportDialog = observer(({answerStore, ...props}: IUICreateErrorReportDialogProps) => {
    return (
        <Paper elevation={0} {...props}>
            <Dialog open={answerStore.isOpenAnswerReportDialog}
                ...
                <DialogActions>
                    <Button onClick={answerStore.closeAnswerReportDialog}
                            color={"error"}
                            endIcon={<CloseIcon/>}>
                        Отмена
                    </Button>
