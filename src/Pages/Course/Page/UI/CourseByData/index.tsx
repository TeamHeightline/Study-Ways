...
export default function CourseByData({
  courseData,
  coursePosition,
  onChangePosition,
  ...
  function openCourse() {
    ...
    function findFirstNonEmptyCourseElementPosition(course: ICourseData): {
      ...
      for (
        let lineIndex = 0;
        lineIndex < course.course_data.length;
        lineIndex++
      ) {
        for (
          let pageIndex = 0;
          pageIndex < course.course_data[lineIndex].SameLine.length;
          pageIndex++
        ) {
          for (
            let positionIndex = 0;
    ...
    const positionOfFirstElement =
      findFirstNonEmptyCourseElementPosition(courseData);
