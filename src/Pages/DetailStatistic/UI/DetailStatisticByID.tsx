    ...
    return (
      <Fragment>
        <TableRow>
          <TableCell>
            <IconButton
              aria-label="expand statisticByIDStore.dataForRow"
              size="small"
          ...
          <TableCell
            component="th"
            scope="statisticByIDStore.dataForRow"
            sx={{ color: textColor }}
          >
          ...
          <Tooltip
            disableInteractive
            title={statisticByIDStore.dataForRow.QuestionTextForStatistic}
          >
            <TableCell sx={{ color: textColor }}>
