...
export default function UIAccessModeSelector({
  ...props
}: IUIAccessModeSelectorProps) {
  const dispatch = useAppDispatch();
  const accessMode = useSelector(
    (state: RootState) => state?.examEditor?.exam_data?.access_mode,
  );
  return (
    <Box {...props}>
