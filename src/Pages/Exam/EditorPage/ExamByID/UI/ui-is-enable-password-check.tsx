...
export default function UIIsEnablePasswordCheck({
  ...props
}: IUIIsEnablePasswordCheckProps) {
  const dispatch = useAppDispatch();
  const is_enable_password_check =
    useSelector(
      (state: RootState) =>
        state?.examEditor?.exam_data?.is_enable_password_check,
    ) || false;
