...
interface IUIMaxAttemptsForQuestionsProps extends BoxProps {

}

export default function UIMaxAttemptsForQuestions({...props}: IUIMaxAttemptsForQuestionsProps) {
    const dispatch = useAppDispatch()
    const max_question_attempts = useSelector((state: RootState) => state?.examEditor?.exam_data?.max_question_attempts) || 10;
