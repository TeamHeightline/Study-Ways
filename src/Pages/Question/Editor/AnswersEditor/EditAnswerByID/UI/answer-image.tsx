...
const AnswerImage = observer(
  ({ answer_object, ...props }: IAnswerImageProps) => {
    ...
    return (
      <Paper elevation={0} {...props}>
        ...
        <div>
          {!isImageDeleted &&
            (answer_object?.imageName?.length > 30
              ? `${answer_object.imageName.slice(0, 20)}...`
        ...
        <Dialog open={isOpenDeleteDialog} onClose={closeDeleteDialog}>
          ...
          <DialogContent>
            <DialogContentText>
              ...
              хранилище, но ответ потеряет на него ссылку, если вы случайно
              открыли эту страницу, просто нажмите "Закрыть"
            </DialogContentText>
          </DialogContent>
          <DialogActions>
            <Button
