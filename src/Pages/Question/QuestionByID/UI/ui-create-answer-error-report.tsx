...
const UiCreateAnswerErrorReport = observer(
  ({ questionStore, ...props }: ICreateErrorInAnswerReportProps) => {
    if (questionStore?.answerIndexForCreateErrorReport == undefined) {
      return <div />;
    }
    const selectedAnswer =
      questionStore.answersArray[
        questionStore?.answerIndexForCreateErrorReport
      ];
    return (
      <Box {...props}>
        <Dialog
          open={
            questionStore.answerIndexForCreateErrorReport !== undefined &&
            !!selectedAnswer
          }
        ...
        >
          ...
          <DialogContent>
            ...
            <Stack alignItems={"center"} sx={{ mt: 2 }}>
              <UISingleAnswerByData
                ...
                isImageDeleted={selectedAnswer.isImageDeleted}
                isSelected={false}
              />
            </Stack>
            <TextField
          ...
          <DialogActions>
            ...
            <Button
              onClick={questionStore.onSendAnswerReportButtonClick}
              endIcon={<SendIcon />}
            >
              Отправить
            </Button>
