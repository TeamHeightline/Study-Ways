...
class QuestionSelectorStore {
    ...
    selectedAuthorID: SelectedAuthorVariantsType = SelectedAuthorVariants.ALLQuestions
        ...
        if (this.selectedAuthorID !== SelectedAuthorVariants.MYQuestions) {
            ...
            this.clientStorage.client.query<Query>({
                ...
                .then((QuestionsIDObject) => {
                    if (String(QuestionsIDObject?.ownerUserId) == String(this.selectedAuthorID)) {
                        if (QuestionsIDObject?.activePage &&
