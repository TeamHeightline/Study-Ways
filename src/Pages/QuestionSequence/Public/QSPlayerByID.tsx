    ...
    <div>
      ...
      <div style={{ overflowX: "auto" }}>
        <Stepper
          nonLinear
          alternativeLabel
          activeStep={processedStore.selectedQuestionIndex}
          sx={{ pb: 2 }}
        >
                ...
                {processedStore.selectedQuestionIndex !== null && (
                  <Grid item xs={11}>
                    <UiQuestionData
                      ...
                      onChange1={(e) => {
                        processedStore.activeQuestionStoreInstance?.changeHardLevelOfHelpText(
                          e.target.value,
                        );
                      }}
                      onClick1={() =>
                        processedStore.activeQuestionStoreInstance?.checkErrors()
                      }
                      height={window.innerHeight}
                      width={window.innerWidth - 100}
                      urlHasBeenPassed={true}
                      questionText={
                        processedStore.activeQuestionStoreInstance?.questionText
                      }
                      questionImgUrl={
                        processedStore.activeQuestionStoreInstance
                          ?.questionImageUrl
                ...
                >
                  {processedStore.selectedQuestionIndex !== null &&
                    processedStore.activeQuestionStoreInstance
                      ...
                      >
                        {processedStore.activeQuestionStoreInstance?.answersArray.map(
                          (answer, aIndex) => (
                            <Card
                              key={aIndex}
                              variant="outlined"
            ...
            <div>
              ...
              <Stack direction={"row"} sx={{ mt: 1 }}>
                <Chart
                  data={
                    processedStore.activeQuestionStoreInstance
                      ?.ArrayForShowNumberOfWrongAnswers
                  }
                >
