...
export default function UIStatusEditDialog({
  ...props
}: IUIStatusEditDialogProps) {
  const dispatch = useAppDispatch();
  const pending_update_user_status = useSelector(
    (state: RootState) => state.statusEditor.pending_update_user_status,
  );
  const selectedUser = useSelector(
    (state: RootState) => state.statusEditor.selectedUser,
  );
