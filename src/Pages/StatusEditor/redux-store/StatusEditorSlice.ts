...
const statusEditorSlice = createSlice({
  ...
  extraReducers: {
    ...
    [loadAllUsersAsync.fulfilled.type]: (
      state,
    ...
    [loadAllUsersAsync.rejected.type]: (
      state,
    ...
    [searchUserAsync.fulfilled.type]: (
      state,
      action: PayloadAction<IBasicUserInformation[]>,
    ) => {
      state.is_users_loading = false;
    ...
    [updateUserStatusAsync.fulfilled.type]: (
      state,
      action: PayloadAction<IBasicUserInformation>,
    ) => {
    ...
    [updateUserStatusAsync.rejected.type]: (
      state,
      action: PayloadAction<string>,
    ) => {
      state.pending_update_user_status = false;
